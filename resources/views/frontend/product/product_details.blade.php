...
@endif
			...
			<div class="review-title"><span class="summary"><b>Summary:</b>&nbsp;{{ $item->summary }}</span><span class="date"><i class="fa fa-calendar"></i><span> {{ Carbon\Carbon::parse($item->created_at)->diffForHumans() }} </span></span></div>
			<div class="text"><b>Comment:</b>&nbsp;{{ $item->comment }}</div>
		 </div>
...
<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-63d51599f9b712ba"></script>
